...
def analyze_xgboost():
    ...
    model_path = os.path.join(STAGES_DIR, 'step4_model_xgboost.joblib')
    data_path = os.path.join(STAGES_DIR, 'step4_data.pkl')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, 'step6_feature_importance_xgboost.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, 'step6_shap_summary_xgboost.png'), dpi=300)
...
def analyze_meta_model():
    ...
    # 1. Wczytaj model i dane
    model_path = os.path.join(STAGES_DIR, 'step5_model_meta_rf.joblib')
    data_path = os.path.join(STAGES_DIR, 'step5_data.pkl')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, 'step6_feature_importance_meta.png'), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(PLOTS_DIR, 'step6_shap_summary_meta.png'), dpi=300)
